...
const Footer = () => {
  ...
  return (
    <Box
      className={`footer ${
        isTab
          ? "relative bg-[var(--gray-2)] py-[50px] top-[40vh] left-0 h-auto right-auto"
    ...
    >
      ...
      <Flex
        ...
        gap={"2"}
        className={` ${
          isTab ? "relative block mb-8 text-center" : "absolute left-0 bottom-0"
        }`}
      ...
      >
        ...
        <Text size="3" weight="light">
          T:{" "}
          <Link
            href={"tele:shukla.vaibhav1077@gmail.com"}
            className="hover:underline"
          >
            +91 7987 744 456
          </Link>
      ...
      >
        ...
        <Text
          ...
          className={
            isTab
              ? "hidden"
              : `label absolute text-right bottom-[100%] right-0 pr-[75px] h-[24px] whitespace-nowrap origin-[100%_0%] rotate-90 after:content-[''] after:absolute after:right-0 after:top-[50%] after:w-[50px] after:h-[1px] after:bg-[#fff]`
          }
        >
          Follow me
        </Text>
